  ...
  render() {
    return (
      <header className="main-header">
        ...
        <nav className="nav-head navbar navbar-default navbar-static-top">
          <div>
            ...
            <ul className="nav pull-right">
              <li className="profiledropdown">
                <button id="actionprofiledropdown" className="dropdown-toggle dropdown-toggle btn btn-link" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <span>{app_state.user_profile.FirstName}</span> <span className="caret"></span> <span className="avatar"><img src={Img2} className="img-circle" alt="" /></span>
                </button>
